...
**My Role:** -I optimized the core C++ firmware to map ASCII characters to servo angles, implementing the precise control logic required to form readable Braille patterns.
